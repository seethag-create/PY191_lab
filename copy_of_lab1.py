...
Original file is located at
    https://colab.research.google.com/drive/1F9aga9a7VAE5GIsdPZOOLBnBO_ehyzT7
...
# A function is a tool that helps you preform a series of moves or set of instructions to a variable that allows to apply many changes in a simple change of variable. Its useful because it helps to save time and be efficient.
